...
func (l *MaskLogger) IsGoroutines() bool {
	return l.Goroutines
}
...
func BuildMaskedResponseBody(ww ResponseWriter, c LogConfig, t1 time.Time, response string, fields map[string]interface{}, mask func(map[string]interface{})) map[string]interface{} {
	if len(c.Response) > 0 {
